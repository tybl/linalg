...
// Template aliases to make it easier to use linalg types in templated test
// cases
template <class T>
...
public:
  ...
  template <class T>
  linalg::vec<T, 1> get(linalg::vec<T, 1>*) {
    return linalg::vec<T, 1>(get<T>());
  }
  template <class T>
  linalg::vec<T, 2> get(linalg::vec<T, 2>*) {
    return linalg::vec<T, 2>(get<T>(), get<T>());
  }
  template <class T>
  linalg::vec<T, 3> get(linalg::vec<T, 3>*) {
    return linalg::vec<T, 3>(get<T>(), get<T>(), get<T>());
  }
  template <class T>
